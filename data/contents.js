...
const CONTENTS = [
  ...
  },
  {
    ...
    tags: ["자기이해", "비교", "정체성", "끈기"],
    summary: "끊임없는 평가와 비교 속에서도 나만의 기준을 지켜나가는 법을 생각합니다.",
    body: "테일러 스위프트는 데뷔 이후 늘 외모, 연애, 이미지에 대한 평가와 비교에 시달렸습니다. 그럴 때마다 그는 남의 시선이 아니라 자신이 쓰고 싶은 음악, 하고 싶은 이야기를 기준으로 삼아 앞으로 나아갔습니다.",
    question: "다른 사람의 평가와 비교 속에서, 나는 무엇을 나만의 기준으로 삼고 있을까?",
    thumbnail: "images/people/taylor-swift.jpg",
    cardnewsId: null,
    purchaseBook: "people"
  },
  {
